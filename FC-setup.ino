...
void intro(){
  ...
  Serial.println(F(""));
  Serial.println(F(""));
  Serial.println(F("Autodrone V1 Setup Program"));
  Serial.println(F(""));
  Serial.println(F("==================================================="));
  delay(1500);
}
...
void check_to_continue(){
  ...
  Serial.println(receiver_input_channel_4);
  Serial.println(channel_2_assign == 0b00000001);
  Serial.println(channel_2_assign == 0b10000001);
  Serial.println(channel_2_assign == 0b00000010);
  Serial.println(channel_2_assign == 0b10000010);
  Serial.println(channel_2_assign == 0b00000011);
  Serial.println(channel_2_assign == 0b10000011);
  Serial.println(channel_2_assign == 0b00000100);
  Serial.println(channel_2_assign == 0b10000100);
...
void interruptFunction() {
 ...
 if(radio.available()) { //get data sent from transmit
     ...
     receiver_input_channel_1 = map(_radioData.x1, 0, 255, 900, 2100);
     receiver_input_channel_2 = map(_radioData.y1, 0, 255, 900, 2100);
     receiver_input_channel_3 = map(_radioData.x2, 0, 255, 900, 2100);
     receiver_input_channel_4 = map(_radioData.y2, 0, 255, 900, 2100);
    // Serial.println(receiver_input_channel_4);
 }
}
